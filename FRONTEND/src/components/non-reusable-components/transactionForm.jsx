...
import { session } from "../Components.js";
    ...
    async function submitForm(event) {
        ...
        try {
            ...
            const response = await axios.post(
                "http://localhost:8001/transaction/save",
                {
                            ...
                            <Row className="mb-3">
                                <Col sm={6}>
                                    ...
                                    >
                                        ...
                                        <option value="REPRESENTATION EXPENSE">
                                            Representation Expense
                                        </option>
                                        <option value="MEDICAL EXPENSE">
                                            Medical Expense
                                        </option>
                                        <option value="COMMUNICATION EXPENSE">
                                            Communication Expense
                                        </option>
                                        <option value="MISCELLANEOUS EXPENSE">
                                            Miscellaneous Expense
                                        </option>
                                        <option value="TOKEN EXPENSE">
                                            Token Expense
                                        </option>
                                    </Form.Select>
                                </Col>
