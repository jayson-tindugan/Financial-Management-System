  ...
  return (
    ...
    <div className="main-content">
        ...
        <ButtonGroup style={{ gap:"5px"}}>
            <Link to="/students">
                <Button variant="secondary" style={{ background:"#526051" }}>Total Students Page</Button>
            </Link>
            <Link to="/officers">
                <Button variant="secondary" style={{ background:"#3E433E" }}>Officers Page</Button>
            </Link>
            <Link to="/expenses">
        ...
        <div className="col2">
            <div className="row1">
                <h1>Notice</h1>
                <p>Welcome to Builders Innovative Technologist Society. Please take note that school records are not directly connected to the website records.</p>
                <p>For questions, inquiries or bug reports regarding the system please contact the BSIT 4D.</p>
            </div>
            <div className="row2">
            ...
            <div className="row3">
                ...
                {/* Icon */}
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"  style={{ color:"#ffffff" }} fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
            ...
            <div className="row5">
                ...
                <h1>BALANCE</h1>
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-eye-slash-fill" viewBox="0 0 16 16" >
                        <path d="m10.79 12.912-1.614-1.615a3.5 3.5 0 0 1-4.474-4.474l-2.06-2.06C.938 6.278 0 8 0 8s3 5.5 8 5.5a7.029 7.029 0 0 0 2.79-.588M5.21 3.088A7.028 7.028 0 0 1 8 2.5c5 0 8 5.5 8 5.5s-.939 1.721-2.641 3.238l-2.062-2.062a3.5 3.5 0 0 0-4.474-4.474L5.21 3.089z"/>
                        <path d="M5.525 7.646a2.5 2.5 0 0 0 2.829 2.829l-2.83-2.829zm4.95.708-2.829-2.83a2.5 2.5 0 0 1 2.829 2.829zm3.171 6-12-12 .708-.708 12 12z"/>
                    </svg>
                </div>
                <h2 style={{ backgroundColor:"#E5E4E2", borderRadius:"12px", borderStyle:"solid", padding:"1rem" }}>₱ 100,00</h2>
            </div>
        </div>
    </div>
    <Sidebar />
